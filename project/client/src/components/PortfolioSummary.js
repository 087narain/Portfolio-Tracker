export default function PortfolioSummary({ portfolioName, totalValue }) {
    ...
    return (
        <div className="w-full max-w-xl bg-gray-100 dark:bg-darkBlue2 shadow-md rounded-lg p-6 text-white">
          <h2 className="text-2xl font-bold mb-3 text-black dark:text-accentBlue">Total value for: {portfolioName}</h2>
          <p className="text-lg text-black dark:text-accentBlue mb-4 flex items-center">
            <span>💰</span>
